	...
	<div class="navbar-collapse ">
		<div class="sm-ul navbar-custom-menu ">
			<ul class=" navbar-nav  tooltip-demo d-flex flex-row align-items-center justify-content-start pull-right">
				<li>
					<a data-toggle="tooltip" data-placement="bottom" title="Booking Cart"
						href="<?php echo WEB_ROOT . 'booking/index.php'; ?>" class="mx-1">
						<i class="fa fa-shopping-cart fa-fw"></i> <span class="px-1">
				...
				<?php if (isset($_SESSION['GUESTID'])) {
					...
					<li class="dropdown messages-menu">
						<a href="#" class="dropdown-toggle mx-1" data-toggle="dropdown">
							...
							<span class="label label-success px-1">
								<?php echo $msgCnt['MSG']; ?>
							</span>
						</a>
						<ul class="dropdown-menu">
							<li class="header">You have
								<?php echo $msgCnt['MSG']; ?> messages
							</li>
							<?php
							...
							while ($row = mysqli_fetch_array($res)) {
								...
								<li>
									<ul class="">
										<li>
											<a class="read"
												href="<?php echo WEB_ROOT; ?>guest/readmessage.php?code=<?php echo $row['CONFIRMATIONCODE']; ?>"
												data-toggle="lightbox" data-id="<?php echo $row['CONFIRMATIONCODE']; ?> ">
												<div class="pull-left">
													<img src="guest/Avatar.jpg" class="img-circle" alt="User Image">
												</div>
												<h4>
													Admin
												</h4>
												<p>Reservation is already
													<?php echo $row['STATUS']; ?>..
												</p>
											</a>
										</li>
						...
						<ul class="dropdown-menu nav nav-stacked">
							<li class="widget-user-header bg-yellow">
								<div class="widget-user-image">
									<img class="img-circle" style="cursor:pointer;width:200px;height:100px;padding:0;"
										data-target="#myModal" data-toggle="modal"
										src="<?php echo WEB_ROOT . $result->LOCATION; ?>" alt="User Avatar">
								</div>
							...
							<li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;"
									href="<?php echo WEB_ROOT; ?>guest/bookinglist.php" data-toggle="lightbox">Bookings
								</a></li>
							<li><a style="color:#000;text-align:left;border-bottom:1px solid #fff;"
									href="<?php echo WEB_ROOT . 'logout.php'; ?>">Logout </a></li>
						</ul>
...
<div class="modal fade" id="LoginModal" tabindex="-1">
	<div class="modal-dialog pb-4">
		<div class="modal-content">
			...
			<div style="display: flex;align-items: center;justify-content: center;gap: 5px;">Don't you have an Account? <a style="display: inline-block;" href="personalinfo.php"
					data-title="Register New Guest" data-toggle="lightbox"> Register</a>
			</div>
		</div><!-- /.modal-content -->
	</div><!-- /.modal-dialog -->
</div><!-- /.modal -->