...
defined('DB_USER') ? null : define("DB_USER","ccabs_test");		  //define our database user	
defined('DB_PASS') ? null : define("DB_PASS","jZuT%(eX_q{Z");			  //define our database Password	
defined('DB_NAME') ? null : define("DB_NAME","ccabs_test"); //define our database Name
