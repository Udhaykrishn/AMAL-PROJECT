...
<div class="super_container">
  <header class="header">
    <div class="header_content d-flex flex-column align-items-center justify-content-lg-end justify-content-center">
      ...
      <!-- Logo -->
      <div class="logo"><a href="#"><img class="logo_1" src="<?php echo WEB_ROOT;?>images/llogo.png" style="width: 180px; height: 150px;"alt=""><img class="logo_2" src="<?php echo WEB_ROOT;?>images/llogo.png" alt=""><img class="logo_3" src="<?php echo WEB_ROOT;?>images/llogo.png" alt=""></a></div>
...
<!--         <div class="search_button">
  ...
  <div class="logo_overlay">
    <div class="logo_overlay_content d-flex flex-column align-items-center justify-content-center">
      <div class="logo"><a href="#"><img src="<?php echo WEB_ROOT;?>images/llogo.png"style="width: 53px; height: 59px; alt=""></a></div>
    </div>
  </div>
  ...
  <div class="home">
    ...
    <div class="home_container d-flex flex-column align-items-center justify-content-center">
      ...
      <div class="home_text text-center">Far from the maddening city crowds, far from your frenzied schedules, unfolds the picturesque paradise that is Manglore, Enjoy your precious moments with us.</div>
      ...
      <div class="row">
        <div class="col">
          <div class="footer_logo text-center">
            <a href="#"><img src="images/llogo.png" style="width: 200px; height: 190px;" alt=""></a>
          </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Address:</div>
                    <div>Beach Road,Manglore,Karnataka</div>
                  </div>
                </div>
              </div>
              <div class="col-lg-4 footer_col">
                <div class="footer_info d-flex flex-column align-items-lg-start align-items-center justify-content-start">
                  <div class="text-center">
                    <div>Mail:</div>
                    <div>reservation@sealuxureresort.com</div>
                  </div>
                </div>
              </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Sea Luxure <i class="fa fa-heart-o" aria-hidden="true"></i> 
