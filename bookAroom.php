...
if(isset($_POST['booknow'])){
    ...
    $days =0;
    $day = dateDiff($_POST['arrival'],$_POST['departure']);  
   ...
   if($day <= 0){
      ...
      addtocart($_POST['ROOMID'],$days, $totalprice,$_POST['arrival'],$_POST['departure'],0);
                  ...
                  <input type="hidden" name="ROOMID" value="<?php echo $result->ROOMID ;?>">
                      ...
                      <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <div class="rooms_price"><?php echo   $result->PRICE ;?>/<span>Day</span></div>
                           <?php echo $btn ; ?> 
                        </div>
                      </div>
